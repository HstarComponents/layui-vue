<template>
  <div class="page-accordion">
    <lv-accordion @shown-change="onShownChange">
      <lv-accordion-item title="我是属性Title">
...
<script>
  export default {
    methods: {
      onShownChange(result) {
        console.log(`item${result.index} status: ${result.shown}`);
      }
    }
  };
